...
var qv = {
    ...
    get: function (endpoint, params, dataType, useDomain) {
      console.log(endpoint+":"+params+":"+dataType)
    ...
    patch: function (endpoint, params, dataType) {
      console.log(endpoint+":"+params+":"+dataType)
        return this.request(endpoint, 'PATCH', params, dataType);
    },
    put: function (endpoint, params, dataType) {
      console.log(endpoint+":"+params+":"+dataType)
        return this.request(endpoint, 'PUT', params, dataType);
    },
    delete: function (endpoint, params, dataType) {
      console.log(endpoint+":"+params+":"+dataType)
        return this.request(endpoint, 'DELETE', params, dataType);
    },
